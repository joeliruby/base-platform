...
@Component
public class PermissionService extends BaseServiceImpl<PermissionMapper,Permission> implements BaseService<Permission>{
	@Autowired
	...
	public Set<Permission> getPermissionsByUserId(Long userId, String tenantId, Long applicationId){
		...
		permissionSet.addAll(permissionMapper.getDirectlyAssignedPermissionIdsByUserId(userId,tenantId,applicationId));
		...
		permissionSet.addAll(permissionMapper.getGroupRoleAssignedPermissionIdsByUserId(userId,tenantId,applicationId));

//		permissionSet.addAll(permissionMapper.getOrderSuitePermissionByUserId(userId,tenantId,applicationId));
	...
	public Set<Permission> getPermissionTreeByTenantIdApplicationIdUserId(String tenantId, Long applicationId, Long userId) {
	...
	public List<Map<Long, String>> findPermissionsByPermissionNamePrefix(String tenantId, Long applicationId,String permissionName) {
