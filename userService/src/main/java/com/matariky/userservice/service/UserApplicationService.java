...
*/
@Service
public class UserApplicationService extends BaseServiceImpl<UserApplicationMapper,UserApplication> implements BaseService<UserApplication>{
