...
/**
 * @description:  Label Import定时 Task 处理
 * @author: bo.chen
...
public class TapeRfidUploadTaskJob   implements BaseJob {
    ...
    private static final TapeRfidUploadTaskJobService tapeRfidUploadTaskJobService = SpringContextUtils.getBean(TapeRfidUploadTaskJobService.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        logger.info("===============开始执行 Label  Print ImporttaskId={}==============", taskId);
        ...
        logger.info("=============== Label Import Task taskId={}执行完毕共用时{}秒==============", taskId,  (System.currentTimeMillis() - startTime) / 1000);
    }
}
