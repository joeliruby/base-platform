...
/**
 * @description:  Label 生产定时 Task 处理
 * @author: bo.chen
...
public class TapeRfidCreateTaskJob  implements BaseJob {
    ...
    private static final TapeRfidCreateTaskJobService tapeRfidCreateTaskJobService = SpringContextUtils.getBean(TapeRfidCreateTaskJobService.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        logger.info("===============开始执行 Label  Generation  Task taskId={}==============", taskId);
       // Lock lock = LockUtil.lock(LockKey.TAPE_RFIDCREATE_TASK_IMMEDIATE_LOCK_KEY + taskId);
        ...
        logger.info("=============== Label  Generation  Task taskId={}执行完毕共用时{}秒==============", taskId,  (System.currentTimeMillis() - startTime) / 1000);
    }
}
