...
/**
 * URL编码， Data 内容的Type 是 application/x-www-form-urlencoded。
 * 
 * <pre>
...
public class URLEncoder implements Serializable{
	...
	/**
	 * 用于 Query 语句的{@link URLEncoder}<br>
	 * 编码器针对URI路径编码，定义如下：
	 * 
	 * <pre>
	 * 0x20 ' ' =》 '+' 
	 ...
	 * </pre>
	 * 
	 * Detail见：https://www.w3.org/TR/html5/forms.html#application/x-www-form-urlencoded-encoding-algorithm
	 */
	...
	/**
	 * 创建用于 Query 语句的{@link URLEncoder}<br>
	 * 编码器针对URI路径编码，定义如下：
	 * 
	 * <pre>
	 * 0x20 ' ' =》 '+' 
	 ...
	 *  Wether 将空格编码为+
	 * 
	 * @param encodeSpaceAsPlus  Wether 将空格编码为+
	 */
