...
public class KeycloakUtils {
	...
	public static String getToken(String loginName, String pazzword, String keycloakUrl, String keycloakRealm,String keycloakSecret, String keycloakClientId, String keycloakGrantType) {
		 
		 HttpClient httpclient = new DefaultHttpClient();
		 // Prepare a request object
		 HttpPost getTokenPost = new HttpPost(keycloakUrl+"/realms/"+keycloakRealm+"/protocol/openid-connect/token"); 
