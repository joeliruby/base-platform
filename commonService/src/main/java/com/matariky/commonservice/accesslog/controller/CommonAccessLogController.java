...
public class CommonAccessLogController {
	...
	private RedisUtils redisUtils;
		...
		public Object getOne(@PathVariable("commonAccessLogId") String id,HttpServletRequest request, HttpServletResponse response) {
		...
		public void listExcel(HttpServletRequest request,HttpServletResponse response,
			...
			String[] titlesCN={ "序号", "用户名", "所属 Tenant ", "访问IP地址", "客户端", "请求接口", "操作 Time "};
			String[] titlesEN={ "Sequence Number", "User Name", "Tenant", "IP Address", "Client", "Http API", "Operation Time"};
			String[] titles=null;
		...
		public void listExcelByIds(HttpServletRequest request,HttpServletResponse response,
			...
			String[] titles = { "序号", "用户名", "所属 Tenant ", "登录IP地址", "客户端", "请求接口", "操作 Time " };
		...
		private static String exportExcel(String[] titles, ServletOutputStream out, List<CommonAccessLog> userList, String fileName) throws Exception {
