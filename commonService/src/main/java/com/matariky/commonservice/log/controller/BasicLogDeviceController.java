...
public class BasicLogDeviceController {
	...
	public PageInfo<BasicLogDevice> list(HttpServletRequest request,BasicLogDevice bean, @ApiParam(value = " Tenant ID", required = true) @PathVariable("tenantId") String tenantId, @ApiParam(value = "Page Index", required = true) @RequestParam("index") int pageIndex,@ApiParam(value = "Page Size", required = true) @RequestParam("perPage") int perPage, @ApiParam(value = "JWT Token", required = true) @RequestHeader("Authorization") String jwt) {
	...
	public ResponseEntity<String> save(@RequestBody BasicLogDevice bean,HttpServletRequest request, HttpServletResponse response) {
		try{
	...
	public ResponseEntity<String> update(@RequestBody BasicLogDevice bean,HttpServletRequest request, HttpServletResponse response) {
		try{
	...
	public Object getOne(@PathVariable("/basicLogDeviceId") Long id, HttpServletRequest request, HttpServletResponse response) {
