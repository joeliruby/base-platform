...
public class BasicLogErrorController {
	...
	public PageInfo<BasicLogError> list(HttpServletRequest request,BasicLogError bean, @ApiParam(value = " Tenant ID", required = true) @PathVariable("tenantId") String tenantId, @ApiParam(value = "Page Index", required = true) @RequestParam("index") int pageIndex,@ApiParam(value = "Page Size", required = true) @RequestParam("perPage") int perPage, @ApiParam(value = "JWT Token", required = true) @RequestHeader("Authorization") String jwt) {
	...
	public ResponseEntity<String> save(@RequestBody BasicLogError bean,HttpServletRequest request, HttpServletResponse response) {
		try{
	...
	public ResponseEntity<String> update(@RequestBody BasicLogError bean,HttpServletRequest request, HttpServletResponse response) {
		try{
	...
	public Object getOne(@PathVariable("/basicLogErrorId") Long id, HttpServletRequest request, HttpServletResponse response) {
