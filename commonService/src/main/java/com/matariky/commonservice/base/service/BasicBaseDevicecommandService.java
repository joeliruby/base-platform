...
*/
@Service
public class BasicBaseDevicecommandService extends BaseServiceImpl<BasicBaseDevicecommandMapper,BasicBaseDevicecommand> implements BaseService<BasicBaseDevicecommand>{
	...
	public List<BasicBaseDevicecommand> getBasicBaseDevicecommandDAC(Map<String, Object> params, HttpServletRequest request) {
