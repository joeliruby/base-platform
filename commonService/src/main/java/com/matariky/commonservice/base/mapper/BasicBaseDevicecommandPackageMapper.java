...
public interface BasicBaseDevicecommandPackageMapper extends BaseMapper<BasicBaseDevicecommandPackage> {
	...
	@DataScope(alias = "t")
	public List<BasicBaseDevicecommandPackage> getBasicBaseDevicecommandPackageAll(
			@Param("params") BasicBaseDevicecommandPackage bean);
	...
	@Override
	List<BasicBaseDevicecommandPackage> selectBatchIds(
	...
	// Query One By Entity
	@Override
	BasicBaseDevicecommandPackage selectOne(
			@Param(Constants.WRAPPER) Wrapper<BasicBaseDevicecommandPackage> queryWrapper);
	...
	// Query All By Entity
	@Override
	List<BasicBaseDevicecommandPackage> selectList(
			@Param(Constants.WRAPPER) Wrapper<BasicBaseDevicecommandPackage> queryWrapper);
	...
	Page<BasicBaseDevicecommandPackage> selectPage(Page<BasicBaseDevicecommandPackage> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseDevicecommandPackage> queryWrapper);

	public List<BasicBaseDevicecommandPackage> getBasicBaseDevicecommandPackageDAC(
	...
	Page<Map<String, Object>> selectMapsPage(Page<BasicBaseDevicecommandPackage> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseDevicecommandPackage> queryWrapper);
