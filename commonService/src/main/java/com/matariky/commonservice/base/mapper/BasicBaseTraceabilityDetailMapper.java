...
public interface BasicBaseTraceabilityDetailMapper extends BaseMapper<BasicBaseTraceabilityDetail> {
	...
	@DataScope(alias = "t")
	public List<BasicBaseTraceabilityDetail> getBasicBaseTraceabilityDetailAll(
			@Param("params") BasicBaseTraceabilityDetail bean);
	...
	// Update By Entity
	@Override
	int update(@Param(Constants.ENTITY) BasicBaseTraceabilityDetail entity,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceabilityDetail> updateWrapper);
	...
	@Override
	List<BasicBaseTraceabilityDetail> selectBatchIds(
	...
	// Query All By Entity
	@Override
	List<BasicBaseTraceabilityDetail> selectList(
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceabilityDetail> queryWrapper);
	...
	Page<BasicBaseTraceabilityDetail> selectPage(Page<BasicBaseTraceabilityDetail> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceabilityDetail> queryWrapper);

	public List<BasicBaseTraceabilityDetail> getBasicBaseTraceabilityDetailDAC(
	...
	Page<Map<String, Object>> selectMapsPage(Page<BasicBaseTraceabilityDetail> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceabilityDetail> queryWrapper);
