...
public interface BasicBaseCreaterfidPrintMapper extends BaseMapper<BasicBaseCreaterfidPrint> {
	...
	// Update By Entity
	@Override
	int update(@Param(Constants.ENTITY) BasicBaseCreaterfidPrint entity,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidPrint> updateWrapper);
	...
	@Override
	List<BasicBaseCreaterfidPrint> selectBatchIds(
	...
	Page<BasicBaseCreaterfidPrint> selectPage(Page<BasicBaseCreaterfidPrint> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidPrint> queryWrapper);
	...
	Page<Map<String, Object>> selectMapsPage(Page<BasicBaseCreaterfidPrint> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidPrint> queryWrapper);
