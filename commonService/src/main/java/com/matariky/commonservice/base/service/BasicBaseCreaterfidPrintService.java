...
*/
@Service
public class BasicBaseCreaterfidPrintService extends BaseServiceImpl<BasicBaseCreaterfidPrintMapper,BasicBaseCreaterfidPrint> implements BaseService<BasicBaseCreaterfidPrint>{
	...
	public List<BasicBaseCreaterfidPrint> getBasicBaseCreaterfidPrintDAC(Map<String, Object> params, HttpServletRequest request) {
