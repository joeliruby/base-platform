...
*/
@Service
public class BasicBaseDeviceCorrelationService extends BaseServiceImpl<BasicBaseDeviceCorrelationMapper,BasicBaseDeviceCorrelation> implements BaseService<BasicBaseDeviceCorrelation>{
	...
	public List<BasicBaseDeviceCorrelation> getBasicBaseDeviceCorrelationDAC(Map<String, Object> params, HttpServletRequest request) {
