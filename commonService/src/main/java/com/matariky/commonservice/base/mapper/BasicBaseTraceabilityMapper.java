...
public interface BasicBaseTraceabilityMapper extends BaseMapper<BasicBaseTraceability> {
	...
	@DataScope(alias = "t")
	public List<BasicBaseTraceability> getBasicBaseTraceabilityAll(@Param("params") BasicBaseTraceability bean);
	...
	// Update By Entity
	@Override
	int update(@Param(Constants.ENTITY) BasicBaseTraceability entity,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceability> updateWrapper);
	...
	Page<BasicBaseTraceability> selectPage(Page<BasicBaseTraceability> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceability> queryWrapper);
	...
	Page<Map<String, Object>> selectMapsPage(Page<BasicBaseTraceability> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseTraceability> queryWrapper);
