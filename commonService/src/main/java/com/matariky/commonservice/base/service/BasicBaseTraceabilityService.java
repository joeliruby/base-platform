...
*/
@Service
public class BasicBaseTraceabilityService extends BaseServiceImpl<BasicBaseTraceabilityMapper,BasicBaseTraceability> implements BaseService<BasicBaseTraceability>{
	...
	public List<BasicBaseTraceability> getBasicBaseTraceabilityAll(BasicBaseTraceability vo){
		...
		return basicBaseTraceabilityMapper.getBasicBaseTraceabilityAll(vo);
	}

	 
	public int getBasicBaseTraceabilityAllCount(){
		return basicBaseTraceabilityMapper.getBasicBaseTraceabilityAllCount();
	}

	 
	public int createBasicBaseTraceability(BasicBaseTraceability bean){
		return basicBaseTraceabilityMapper.createBasicBaseTraceability(bean);
	}

	 
	 
	public int createBasicBaseTraceabilityWithOrg(BasicBaseTraceability bean, HttpServletRequest request){
	...
	public int updateBasicBaseTraceability(BasicBaseTraceability bean){
		return basicBaseTraceabilityMapper.updateById(bean);
	}

	 
	public int delBasicBaseTraceabilityById(int id){
		return basicBaseTraceabilityMapper.delBasicBaseTraceabilityById(id);
	}

	 
	public BasicBaseTraceability getBasicBaseTraceabilityById(int id){
		return basicBaseTraceabilityMapper.getBasicBaseTraceabilityById(id);
	}

	public List<BasicBaseTraceability> getBasicBaseTraceabilityDAC(Map<String, Object> params, HttpServletRequest request) {
		strategyCodeToParams(params, request);
		return basicBaseTraceabilityMapper.getBasicBaseTraceabilityDAC( params);
	}

	public Long getBasicBaseTraceabilityDACCount(Map<String, Object> params,HttpServletRequest request) {
		...
		return basicBaseTraceabilityMapper.getBasicBaseTraceabilityDACCount(params);
	}
