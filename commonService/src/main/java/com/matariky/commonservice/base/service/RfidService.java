...
public class RfidService {
    ...
    public RfidTagInfo getReceiveRfidData(Boolean isOne) {
        ...
        if (isOne) {
            ...
            List<EPCAndTIDVO> list = epcList.stream().collect(Collectors.collectingAndThen(Collectors.toCollection(() -> new TreeSet<>(Comparator.comparing(o -> o.getEpc()))), ArrayList::new));
