...
public interface BasicBaseFormConfigMapper extends BaseMapper<BasicBaseFormConfig> {
	...
	@DataScope(alias = "t")
	public List<BasicBaseFormConfig> getBasicBaseFormConfigAll(@Param("params") BasicBaseFormConfig bean);
	...
	// Update By Entity
	@Override
	int update(@Param(Constants.ENTITY) BasicBaseFormConfig entity,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseFormConfig> updateWrapper);
	...
	Page<BasicBaseFormConfig> selectPage(Page<BasicBaseFormConfig> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseFormConfig> queryWrapper);
	...
	Page<Map<String, Object>> selectMapsPage(Page<BasicBaseFormConfig> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseFormConfig> queryWrapper);
