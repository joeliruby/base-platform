...
public interface BasicBaseCreaterfidFactoryMapper extends BaseMapper<BasicBaseCreaterfidFactory> {
	...
	// Update By Entity
	@Override
	int update(@Param(Constants.ENTITY) BasicBaseCreaterfidFactory entity,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidFactory> updateWrapper);
	...
	@Override
	List<BasicBaseCreaterfidFactory> selectBatchIds(
	...
	// Query All By Entity
	@Override
	List<BasicBaseCreaterfidFactory> selectList(
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidFactory> queryWrapper);
	...
	Page<BasicBaseCreaterfidFactory> selectPage(Page<BasicBaseCreaterfidFactory> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidFactory> queryWrapper);

	public List<BasicBaseCreaterfidFactory> getBasicBaseCreaterfidFactoryDAC(
	...
	Page<Map<String, Object>> selectMapsPage(Page<BasicBaseCreaterfidFactory> page,
			@Param(Constants.WRAPPER) Wrapper<BasicBaseCreaterfidFactory> queryWrapper);
