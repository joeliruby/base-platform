...
*/
@Service
public class BasicBaseFormExtendService extends BaseServiceImpl<BasicBaseFormExtendMapper, BasicBaseFormExtend> implements BaseService<BasicBaseFormExtend> {
