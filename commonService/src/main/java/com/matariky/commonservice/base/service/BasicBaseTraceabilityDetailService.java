...
*/
@Service
public class BasicBaseTraceabilityDetailService extends BaseServiceImpl<BasicBaseTraceabilityDetailMapper,BasicBaseTraceabilityDetail> implements BaseService<BasicBaseTraceabilityDetail>{
	...
	public List<BasicBaseTraceabilityDetail> getBasicBaseTraceabilityDetailDAC(Map<String, Object> params, HttpServletRequest request) {
