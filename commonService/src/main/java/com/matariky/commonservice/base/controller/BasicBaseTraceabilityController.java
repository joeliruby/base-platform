...
public class BasicBaseTraceabilityController {
	...
	public Object list(HttpServletRequest request,BasicBaseTraceability bean, @ApiParam(value = " Tenant ID", required = true) @PathVariable("tenantId") String tenantId, @ApiParam(value = "Page Index", required = true) @RequestParam("index") int pageIndex,@ApiParam(value = "Page Size", required = true) @RequestParam("perPage") int perPage, @ApiParam(value = "JWT Token", required = true) @RequestHeader("Authorization") String jwt) {
		PageHelper.startPage(pageIndex, perPage);
		PageInfo<BasicBaseTraceability> page = new PageInfo( basicBaseTraceabilityService.getBasicBaseTraceabilityAll(bean));
	...
	public Object daclist(HttpServletRequest request,@ApiIgnore @RequestParam Map<String, Object> params,	@ApiParam(value = " Tenant ID", required = true) @PathVariable("tenantId") String tenantId,	@ApiParam(value = "JWT Token", required = true) @RequestHeader("Authorization") String jwt) {
	 ...
	 if (dict == null) {
		...
		List<BasicBaseTraceability> commonDictList =basicBaseTraceabilityService.getBasicBaseTraceabilityDAC(params, request);
	...
	public Object save(@RequestBody BasicBaseTraceability bean,HttpServletRequest request, HttpServletResponse response) {
		try{
	...
	public Object update(@RequestBody BasicBaseTraceability bean,HttpServletRequest request, HttpServletResponse response) {
		try{
	...
	public Object getOne(@PathVariable("/basicBaseTraceabilityId") Long id, HttpServletRequest request, HttpServletResponse response) {
