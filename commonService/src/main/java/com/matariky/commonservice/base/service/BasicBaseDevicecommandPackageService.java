...
*/
@Service
public class BasicBaseDevicecommandPackageService extends BaseServiceImpl<BasicBaseDevicecommandPackageMapper,BasicBaseDevicecommandPackage> implements BaseService<BasicBaseDevicecommandPackage>{
	...
	public int createBasicBaseDevicecommandPackageWithOrg(BasicBaseDevicecommandPackage bean, HttpServletRequest request){
	...
	public List<BasicBaseDevicecommandPackage> getBasicBaseDevicecommandPackageDAC(Map<String, Object> params, HttpServletRequest request) {
