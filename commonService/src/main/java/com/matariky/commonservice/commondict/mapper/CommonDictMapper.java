...
public interface CommonDictMapper extends EnhanceBaseMapper<CommonDict> {
	...
	// Configuration json
	public void updateValueByKeyAndTenantId(@Param("dictTypeId") String dictTypeId, @Param("dictKey") String dictKey,
			@Param("dictValue") String dictValue, @Param("tenantId") String tenantId);
	...
	Page<Map<String, Object>> selectMapsPage(Page<CommonDict> page,
			@Param(Constants.WRAPPER) Wrapper<CommonDict> queryWrapper);
	...
	public CommonDict getDictionaryItemByTypeAndKey(@Param("dictTypeKey") String dictTypeKey,
			@Param("dictKey") String dictKey, @Param("tenantCode") String tenantCode);
	...
	public CommonDict getDictionaryItemById(@Param("id") String id, @Param("dictKey") String dictKey,
	...
	public String getDictValueByTenantIdAndKey(@Param("tenantId") String extractTenantIdFromHttpReqeust,
			@Param("dictKey") String storageDictType);

	@Select("select dict_value from common_dict where tenant_id =#{tenantId} and dict_key=#{permissionId} AND dict_type_id =#{dictTypeId}")
	public String getDictValueByTenantIdAndKeyAndDictTypeId(@Param("tenantId") String tenantId,
			@Param("permissionId") String permissionId, @Param("dictTypeId") String dictTypeId);

	public CommonDict getCommonDictByIdTenantIdAndDictType(@Param("permissionId") String permissionId,
			@Param("tenantId") String tenantId, @Param("dictTypeId") Long id);
