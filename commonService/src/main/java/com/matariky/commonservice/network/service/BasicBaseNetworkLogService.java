...
*/
@Service
public class BasicBaseNetworkLogService extends BaseServiceImpl<BasicBaseNetworkLogMapper,BasicBaseNetworkLog> implements BaseService<BasicBaseNetworkLog>{
