 ...
 */
@Service
public class OrderSuiteConfigService extends BaseServiceImpl<OrderSuiteConfigMapper, OrderSuiteConfig> implements BaseService<OrderSuiteConfig> {
    ...
    public String getOrderSuiteConfigByParams(Map<String, Object> params) {
        ...
        if(orderSuiteConfig != null){
            ...
            if(params.get("startTime") != null) {
                ...
                OrderInfo orderInfo = orderInfoMapper.selectById(params.get("orderId")!= null ? Long.parseLong(params.get("orderId").toString()) : 0);
                if(orderInfo != null){
                    if(params.get("endTime") != null){
                        if(orderInfo.getExpirationEndTime() >= DateUtils.parse(params.get("endTime").toString(),"yyyy-MM-dd").getTime()){
                ...
                if(params.get("chargeMode") != null){
                    if(params.get("chargeMode").toString().equals("1")){
                        ...
                        if(params.get("accountNumber") != null){
                            ...
                            b = b1.multiply(orderSuiteConfig.getAveragePrice()).multiply(BigDecimal.valueOf(accountNumber));
                        }
                    }
                }
            }
