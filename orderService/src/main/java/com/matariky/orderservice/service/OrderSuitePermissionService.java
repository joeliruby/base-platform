 ...
 */
@Service
public class OrderSuitePermissionService extends BaseServiceImpl<OrderSuitePermissionMapper, OrderSuitePermission> implements BaseService<OrderSuitePermission> {
    ...
    public List<OrderSuitePermission> getOrderSuitePermissionDAC(Map<String, Object> params, HttpServletRequest request) {
